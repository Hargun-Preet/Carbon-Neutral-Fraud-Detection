...
### Final Comparison Table (5-Fold Average)

| Metric                | Model                   | Mean (Average) | Std. Dev. (±) |
| :-------------------- | :---------------------- | :------------: | :-----------: |
| **F1-Score**          | DNN (Baseline)          |     0.2700     |    0.0401     |
|                       | **LightGBM (Proposed)** |   **0.6563**   |  **0.0516**   |
| **AUC**               | DNN (Baseline)          |     0.8336     |    0.0114     |
|                       | **LightGBM (Proposed)** |   **0.9689**   |  **0.0028**   |
| **Recall**            | DNN (Baseline)          |     0.1600     |    0.0278     |
|                       | **LightGBM (Proposed)** |   **0.8470**   |  **0.0075**   |
| **Precision**         | DNN (Baseline)          |     0.8805     |    0.0125     |
|                       | **LightGBM (Proposed)** |     0.5387     |    0.0696     |
| **Training Time (s)** | DNN (Baseline)          |     67.35      |     16.35     |
|                       | **LightGBM (Proposed)** |   **42.08**    |   **16.62**   |
| **Energy (Wh)**       | DNN (Baseline)          |     1.0012     |    0.2407     |
|                       | **LightGBM (Proposed)** |   **0.6280**   |  **0.2405**   |
| **CO₂ Emissions (g)** | DNN (Baseline)          |     0.7143     |    0.1717     |
|                       | **LightGBM (Proposed)** |   **0.4480**   |  **0.1716**   |
